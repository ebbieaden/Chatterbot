...
export default function Home() {
  ...
  const [messages, setMessages] = useState([
    {
      role: "assistant",
      content: "Hello Baby, this is Aden. He would help you with whatever you need"
    },
  ]);
  ...
  return(
    <main className="flex min-h-screen flex-col items-center justify-between px-24 py-5">
          <h1 className="text-5xl font-sans"><b>Aden</b>Bot</h1>
          ...
          {isLoading ? <div className="self-start bg-gray bg-gray-200 text-gray-800 w-max max-w-[18rem] rounded-md px-4 py-3 h-min">*thinking</div> : ""}
    </div>
